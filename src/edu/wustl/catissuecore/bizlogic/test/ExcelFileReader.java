...
public class ExcelFileReader {
	...
	public ExcelFileReader() {
		System.out.println("START Excel file ReaderConstructor");
		System.out.println("END Excel file ReaderConstructor");
	}

	public String[][] setInfo(String fileName) throws Exception {
		System.out.println("---------START ExcelFileReader.setInfo()---------");
		String allCP[][] = null;
		try {
			this.fileName = fileName;
